...
function App() {
   ...
   const handleReveal = () => {
      let total = 0;
      setPointCard1(totalPointCard(user1,total));
      let total1 = totalPointCard(user1,total);
      setPointCard1(totalPointCard(user2,total));
      let total2 = totalPointCard(user2,total);
      setPointCard1(totalPointCard(user3,total));
      let total3 = totalPointCard(user3,total);
      setPointCard1(totalPointCard(user4,total));
      let total4 = totalPointCard(user4,total);
