...
function App() {
   ...
   const handleReveal = () => {
      ...
      if(lastNumber(total1)===lastNumber(total2)===lastNumber(total3)===lastNumber(total4)){
         setPoint1(point1);
         setPoint2(point2);
         setPoint3(point3);
         setPoint4(point4);
      }
      else if(lastNumber(total1)===lastNumber(total2) === lastNumber(total3) === findMaxPointCard(num)){
         setPoint1(point1+900/3);
         setPoint2(point2+900/3);
         setPoint3(point3+900/3);
         setPoint4(point4-900);
      }
      else if(lastNumber(total1)===lastNumber(total3) === lastNumber(total4) === findMaxPointCard(num)){
         setPoint1(point1+900/3);
         setPoint2(point2-900);
         setPoint3(point3+900/3);
         setPoint4(point4+900/3);
      }
      else if(lastNumber(total2)===lastNumber(total3) === lastNumber(total4) === findMaxPointCard(num)){
         setPoint1(point1-900);
         setPoint2(point2+900/3);
         setPoint3(point3+900/3);
         setPoint4(point4+900/3);
      }
      else if(lastNumber(total1)===lastNumber(total2) === findMaxPointCard(num)){
         setPoint1(point1+900);
         setPoint2(point2+900);
         setPoint3(point3-900);
         setPoint4(point4-900);
      }
      else if(lastNumber(total1)===lastNumber(total3) === findMaxPointCard(num)){
         setPoint1(point1+900);
         setPoint2(point2-900);
         setPoint3(point3+900);
         setPoint4(point4-900);
      }
      else if(lastNumber(total1)===lastNumber(total4) === findMaxPointCard(num)){
         setPoint1(point1+900);
         setPoint2(point2-900);
         setPoint3(point3-900);
         setPoint4(point4+900);
      }
      else if(lastNumber(total2)===lastNumber(total3) === findMaxPointCard(num)){
         setPoint1(point1-900);
         setPoint2(point2+900);
         setPoint3(point3+900);
         setPoint4(point4-900);
      }
      else if(lastNumber(total2)===lastNumber(total4) === findMaxPointCard(num)){
         setPoint1(point1-900);
         setPoint2(point2+900);
         setPoint3(point3-900);
         setPoint4(point4+900);
      }
      else if(lastNumber(total3)===lastNumber(total4) === findMaxPointCard(num)){
         setPoint1(point1-900);
         setPoint2(point2-900);
         setPoint3(point3+900);
         setPoint4(point4+900);
