      ...
      <div className="app">
         ...
         <div className="card-top">
               <div className='card'>
                  ...
                  {checkCard ? (<p className='point'>Point of 3 cards: {total1}</p>) : (<p className='point'>Point of 3 cards: 0</p>)}
               </div>
         </div>
         <div className="card-right">
               <div className='card'>
                  ...
                  <p className='point'>Point: 15000</p>
                  <p className='user'>Dung</p>
                  {checkCard ? (<p className='point'>Point of 3 cards: {total2}</p>) : (<p className='point'>Point of 3 cards: 0</p>)}
               </div>
         </div>
      </div>
   );
